...
Kamiar_Climate <- read.csv("rawdata/ma_20_85.csv", header=TRUE)
Kamiar_NoClimate <- read.csv("rawdata/ma_20_26.csv", header=TRUE)
...
write.csv(Kahn_8.5_2030, file = "cleandata/Kahn_RCP8.5_10_ma20_data_clean.csv")
write.csv(Kahn_2.6_2030, file = "cleandata/Kahn_RCP2.6_10_ma20_data_clean.csv")
write.csv(Kahn_8.5_2050, file = "cleandata/Kahn_RCP8.5_30_ma20_data_clean.csv")
write.csv(Kahn_2.6_2050, file = "cleandata/Kahn_RCP2.6_30_ma20_data_clean.csv")
write.csv(Kahn_8.5_2070, file = "cleandata/Kahn_RCP8.5_50_ma20_data_clean.csv")
write.csv(Kahn_2.6_2070, file = "cleandata/Kahn_RCP2.6_50_ma20_data_clean.csv")
write.csv(Kahn_8.5_2100, file = "cleandata/Kahn_RCP8.5_80_ma20_data_clean.csv")
write.csv(Kahn_2.6_2100, file = "cleandata/Kahn_RCP2.6_80_ma20_data_clean.csv")
